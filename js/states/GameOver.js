...
LoiDeMurphy.GameOver.prototype = {
    create: function(){
        this.splash = this.add.sprite(400, 250, 'gameOver');
        this.splash.anchor.setTo(0.5);
        this.splash.scale.setTo(0.2,0.2);
        var textGameOver = this.game.add.sprite(400,330,"texteGameOver");
        textGameOver.anchor.setTo(0.5);
        textGameOver.scale.setTo(0.4,0.4);
        var playButton = this.game.add.button(400,430,"replay-bouton",this.playTheGame,this);
